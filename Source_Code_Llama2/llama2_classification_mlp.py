...
def main(args):
    ...
    results_dir = f"experiments/llama2_mixed_726/classification-sampleFraction-{args.train_sample_fraction}_epochs-{args.epochs}_rank-{args.lora_r}_dropout-{args.dropout}"

...
def main(args):
    train_dataset, test_dataset = get_data_for_ft(
    ...
    # 模型输出保存路径，输出不同模型时需要修改路径
    results_dir = f"experiments/origin_phrase/classification-sampleFraction-{args.train_sample_fraction}_epochs-{args.epochs}_rank-{args.lora_r}_dropout-{args.dropout}"
